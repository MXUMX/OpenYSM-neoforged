package org.openysm.geckolib3.core;

import org.openysm.audio.IAudioStreamFactory;
import org.openysm.client.event.ClientTickEvent;
import org.openysm.geckolib3.core.enums.AnimationState;
...
import org.openysm.geckolib3.core.manager.AnimationData;
import org.openysm.geckolib3.core.controller.IAnimationController;
import org.openysm.client.animation.molang.PhysicsManager;
...
import org.openysm.geckolib3.core.molang.storage.IForeignVariableStorage;
import org.openysm.geckolib3.core.molang.value.IValue;
import org.openysm.geckolib3.core.processor.AnimationProcessor;
...
import org.openysm.geckolib3.core.util.RateLimiter;
import org.openysm.util.log.ILogger;
...
public abstract class AnimatableEntity<TEntity extends Entity> {
    ...
    public AnimationEvent<?> processAnimationImpl(float partialTick, boolean z) {
        ...
        float frameTime = partialTick != 1.0f ? partialTick : Minecraft.getInstance().getTimer().getGameTimeDeltaPartialTick(false);
    ...
    public void initAnimationControllers(@NotNull GeoModel model, Object2ReferenceMap<String, List<IValue>> object2ReferenceMap) {
        reset();
        this.currentModel = new org.openysm.geckolib3.geo.animated.AnimatedGeoModel(model);
