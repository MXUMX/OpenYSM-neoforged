        ...
        if (!offhandItem.isEmpty() || !mainHandItem.isEmpty()) {
            ...
            if (!animatedGeoModel.rightHandBones().isEmpty()) {
                if (SlashBladeCompat.isSlashBladeItem(mainHandItem)) {
                    ...
                    if (useExtraPlayer && !mainHandItem.isEmpty() && bufferSource instanceof MultiBufferSource.BufferSource vanillaBufferSource) {
            ...
            if (!animatedGeoModel.leftHandBones().isEmpty()) {
                if (SlashBladeCompat.isSlashBladeItem(offhandItem)) {
                    ...
                    if (useExtraPlayer && !offhandItem.isEmpty() && bufferSource instanceof MultiBufferSource.BufferSource vanillaBufferSource) {
                        vanillaBufferSource.endBatch();
                    }
                }
            }
