...
import org.openysm.client.animation.molang.functions.ysm.*;
...
import org.openysm.geckolib3.util.MathInterpolation;
import org.openysm.mixin.client.FishingHookAccessor;
import org.openysm.mixin.client.ThrowableItemProjectileAccessor;
import org.openysm.geckolib3.core.EntityFrameStateTracker;
...
public class YSMBinding extends ContextBinding {
    ...
    private static Object dumpEffects(IContext<Entity> context) {
        ...
        if (context.entity() instanceof Arrow) {
            activeEffects = ((Arrow) context.entity()).getPickupItemStackOrigin().getOrDefault(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).getAllEffects();
