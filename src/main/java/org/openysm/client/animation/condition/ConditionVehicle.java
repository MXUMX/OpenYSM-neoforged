package org.openysm.client.animation.condition;
...
public class ConditionVehicle {
    ...
    public void addTest(String name) {
        ...
        if (!name.startsWith(this.tagPre) || ResourceLocation.tryParse(strSubstring) == null || (iTagManagerTags = ForgeRegistries.ENTITY_TYPES.tags()) == null) {
            return;
        }
