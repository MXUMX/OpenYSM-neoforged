...
import org.openysm.ResourceCleanupHelper;
import org.openysm.OpenYSM;
import org.openysm.client.texture.ITextureMap;
...
public class UploadManager {
    ...
    private static class TextureLocatable implements IResourceLocatable {
        ...
        TextureLocatable(int resolution) {
            this.resourceLocation = ResourceLocation.fromNamespaceAndPath(OpenYSM.MOD_ID, "textures/" + ++textureCounter);
            this.resolution = resolution;
