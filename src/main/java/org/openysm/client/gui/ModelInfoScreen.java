...
import org.openysm.client.gui.button.AuthorButton;
...
public class ModelInfoScreen extends Screen {
    ...
    private static final ResourceLocation DEFAULT_AVATAR = ResourceLocation.fromNamespaceAndPath(OpenYSM.MOD_ID, "texture/default_avatar.png");

    private static final Map<String, Component> URL_LABELS = ImmutableMap.of("home", Component.translatable("gui.openysm.url.home"), "donate", Component.translatable("gui.openysm.url.donate"));
    ...
    private void initWidgets() {
        ...
        for (int i = 0; i < authorInfo.size(); i++) {
            ...
            if (avatar != null) {
                textureManager.register(ResourceLocation.fromNamespaceAndPath(OpenYSM.MOD_ID, "avatars/" + i), avatar);
    ...
    public void init() {
        ...
        addRenderableWidget(new FlatColorButton(this.guiLeft + 2, this.guiTop + 25, 18, 100, Component.literal("<"), button -> {
            ...
            init();
        }).setTooltipText("gui.openysm.pre_page"));
        addRenderableWidget(new FlatColorButton(this.guiLeft + 25 + 375, this.guiTop + 25, 18, 100, Component.literal(">"), button2 -> {
            ...
            init();
        }).setTooltipText("gui.openysm.next_page"));
        ...
        addRenderableWidget(new FlatColorButton(this.guiLeft + 310, linkY, 85, 20, Component.translatable("gui.openysm.model.return"), button4 -> {
