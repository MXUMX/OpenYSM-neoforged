...
public class S2CSyncStarModelsPacket {
    ...
    public static void handleCapability(S2CSyncStarModelsPacket message) {
        ...
        if (minecraft.player != null) {
            org.openysm.capability.YSMCapabilities.get(minecraft.player, StarModelsCapabilityProvider.STAR_MODELS_CAP).ifPresent(cap -> cap.setStarModels(message.starModels));
        }
    }
}