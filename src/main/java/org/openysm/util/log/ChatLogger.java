...
public class ChatLogger implements ILogger {
    ...
    public void logComponent(Component component) {
        ...
        Minecraft.getInstance().execute(() -> {
            Minecraft.getInstance().player.sendSystemMessage(Component.translatable("message.openysm.model.debug_animation.output").append(component));
        });
    }
}