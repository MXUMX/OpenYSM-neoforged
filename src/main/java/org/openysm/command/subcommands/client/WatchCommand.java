...
public class WatchCommand {
    ...
    private static int watchClear(CommandContext<CommandSourceStack> context) {
        ...
        Minecraft minecraft = Minecraft.getInstance();
        minecraft.execute(() -> {
            org.openysm.capability.YSMCapabilities.get(minecraft.player, PlayerCapabilityProvider.PLAYER_CAP).ifPresent(cap -> AnimationDebugOverlay.getMolangWatch().clearAll());
        });
