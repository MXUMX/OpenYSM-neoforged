...
public class ClientLazyCapabilityProvider implements ICapabilityProvider {
    ...
    public ClientLazyCapabilityProvider(VehicleCapabilityProvider capabilityProvider, @Nullable ProjectileCapabilityProvider projectileCapabilityProvider) {
        this.capability = new ClientLazyCapability(capabilityProvider, projectileCapabilityProvider);
    }
